...
ax1.set_title('随机森林 - 实际vs预测', fontsize=14, fontweight='bold')
...
ax2.set_title('随机森林 - 残差分布', fontsize=14, fontweight='bold')
...
ax3.set_title('随机森林 - 特征重要性', fontsize=14, fontweight='bold')
ax3.set_xlabel('重要性（%）', fontsize=12)
ax3.set_ylabel('特征', fontsize=12)

plt.tight_layout()
plt.savefig('随机森林_结果.png', dpi=150, bbox_inches='tight')
plt.close()
