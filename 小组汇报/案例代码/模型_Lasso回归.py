...
ax1.set_title('Lasso回归 - 实际vs预测', fontsize=14, fontweight='bold')
...
ax2.set_title('Lasso回归 - 残差分布', fontsize=14, fontweight='bold')
ax2.set_xlabel('残差', fontsize=12)
ax2.set_ylabel('频数', fontsize=12)
ax2.grid(axis='y', alpha=0.3)

plt.tight_layout()
plt.savefig('Lasso回归_结果.png', dpi=150, bbox_inches='tight')
plt.close()

print(f"\n结果已保存: Lasso回归_结果.png")
print("="*70)
